...
/**
 * import all related action creators here
 */
...
function mapDispatchToProps(dispatch) {
  /**
   * a set of all actions that we want to use as a prop
   */
  return {
    addTodoProp: (todo) => dispatch(addTodo(todo))
  }
}
